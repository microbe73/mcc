structure Scan = struct
  ...
  fun scan (s : string) : Token.token * string =
        ...
        val regexes = [
          ...
          ("-=",                  fn match => matched Token.MinEq match),
          ("\\+=",                fn match => matched Token.PlusEq match),
          ("\\*=",                fn match => matched Token.TimesEq match),
          ("\\+\\+",              fn match => matched Token.PlusPlus match),
          ("--",                  fn match => matched Token.MinMin match),
